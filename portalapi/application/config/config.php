...
|
*/
	$config['base_url']	= 'http://aertripapi.local.com';
    define('ABSOLUTE_DOC_ROOT',$_SERVER['DOCUMENT_ROOT']);
    define('DOC_ROOT', ABSOLUTE_DOC_ROOT.'/portalapi');
    define('DOC_ROOT_FRONT', ABSOLUTE_DOC_ROOT.'/portal' );
    define('FRONT_URL',  'http://aertrip.local.com/');
    define('FRONT_END_URL',  'http://aertrip.local.com');
    define('SERVICE_URL',  'http://aertripapi.local.com');
    define('ENV_BYPASSED',  true);
